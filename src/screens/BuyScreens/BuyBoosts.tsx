...
const BuyBoosts: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      setProducts(response.data.data.boosts);
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Buy Boosts</Text>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.infoSection}>
          ...
          <Text style={styles.infoDescription}>
            Boosts put your profile at the top of the stack for 30 minutes, 
            increasing your chances of getting matches.
          </Text>
        </View>
